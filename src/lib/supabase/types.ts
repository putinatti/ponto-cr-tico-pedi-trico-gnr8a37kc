...
//     USING: true
//   Policy "public_select_articles" (SELECT, PERMISSIVE) roles={public}
//     USING: true
// Table: categories
//   Policy "authenticated_select_categories" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
//   Policy "public_select_categories" (SELECT, PERMISSIVE) roles={public}
//     USING: true
// Table: navigation_items
//   Policy "authenticated_select_navigation" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
//   Policy "public_select_navigation" (SELECT, PERMISSIVE) roles={public}
//     USING: true
